...
<head>
   ...
   <!-- Favicon icon -->
   <link rel="icon" href="{{asset('admin/img/logo1.png')}}">
   ...
   <link rel="stylesheet" href="{{asset('admin/assets/plugins/bootstrap-datepicker/css/bootstrap-datetimepicker.css')}}" />
   <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/plugins/bootstrap-daterangepicker/daterangepicker.css')}}" />

   <!-- Select 2 css -->
   <link rel="stylesheet" href="{{asset('admin/assets/plugins/select2/dist/css/select2.min.css')}}" />
   <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/plugins/select2/css/s2-docs.css')}}">

   <!-- Multi Select css -->
   <link rel="stylesheet" href="{{asset('admin/assets/plugins/bootstrap-multiselect/dist/css/bootstrap-multiselect.css')}}" />
   <link rel="stylesheet" href="{{asset('admin/assets/plugins/multiselect/css/multi-select.css')}}" />

   <!-- Color Picker css -->
   <link rel="stylesheet" href="{{asset('admin/assets/plugins/spectrum/spectrum.css')}}" />
   ...
   <link type="text/css" rel="stylesheet" href="{{asset('admin/assets/plugins/syntaxhighlighter/styles/shCoreDjango.css')}}"/>
